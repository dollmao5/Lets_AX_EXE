...
![AI Studio Build Advanced settings와 Framework 선택 화면](/assets/aistudio/CH06/framework-dropdown.png)

Advanced settings에서는 모델, 시스템 지침, 프레임워크, 마이크 입력 등을 정합니다. 여기서 React / Next.js / Angular 중 하나를 고를 수 있습니다.

![Google AI Studio Build로 만든 Lotto Lucky Draw 앱 작업 화면](/assets/aistudio/CH06/lotto-app-workspace.png)
...
![AI Studio Build 공유 설정 화면](/assets/aistudio/CH06/share-settings.png)

Share는 특정 동료와 앱을 같이 보는 협업 설정입니다. 링크 공유나 사람별 권한 지정이 이 단계입니다.

![AI Studio Build Publish 패널](/assets/aistudio/CH06/publish-panel.png)
